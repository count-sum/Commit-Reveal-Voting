...
describe('CommitRevealLogic', () => {
    ...
    describe('Vote Commitment', () => {
        it('should accept valid commitments', async () => {
            ...
            await context.contracts.commitRevealLogic.commit(voter.address, voteData.commitment);

            const voterInfo = await context.contracts.commitRevealLogic.votes(voter.address);
        ...
        it('should prevent duplicate commitments', async () => {
            ...
            await expect(
                context.contracts.commitRevealLogic.commit(voter.address, voteData.commitment)
